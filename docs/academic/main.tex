...
first-class user parameters). It ships ten trading strategies across four families,
multi-asset support (equities, ETFs, FX, crypto) with native trading calendars per asset
class, both daily and hourly bar resolution, and a five-agent backend whose single
LLM-backed agent (the Explanation Agent) is opt-in by default. This document covers the
