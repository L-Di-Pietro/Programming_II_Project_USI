...
\begin{abstract}
\noindent
QuantBacktest is a web-based event-driven backtesting framework for retail quantitative
...
project plan, the development diary, the underlying mathematics and data-science
methodology, sample results and an economic reflection, the lessons we learned, and an
acknowledgement of the generative-AI tools that participated in the project.
\end{abstract}
...
% ---------- Sections --------------------------------------------------------
\input{01_project_plan}
\input{02_project_diary}
\input{03_methodology}
\input{04_sample_results}
\input{05_lessons_learned}
\input{06_ai_acknowledgement}
