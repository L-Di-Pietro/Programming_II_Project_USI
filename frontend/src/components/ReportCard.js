...
function Actions({ report, loading, onGenerate, }) {
    ...
    return (_jsx("button", { className: "font-mono text-[11px] text-accent-cyan hover:opacity-80 underline underline-offset-2", onClick: onGenerate, children: "Regenerate" }));
}
function fmt(e) {
